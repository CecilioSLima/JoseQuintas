...
METHOD TelaDados( lEdit ) CLASS PBAR0010Class
   ...
   WITH OBJECT ::cnMySql
      ...
      :Execute()
      mbrCodBar  := :StringSql( "BRCODBAR", 22 )
      mbrCodBar2 := :StringSql( "BRCODBAR2", 22 )
      mbrItem    := :StringSql( "BRITEM", 6 )
      mbrGarCom  := :DateSql( "BRGARCOM" )
      mbrGarVen  := :DateSql( "BRGARVEN" )
      mbrPedCom  := :StringSql( "BRPEDCOM", 6 )
      mbrPedVen  := :StringSql( "BRPEDVEN", 6 )
      mbrInfCom  := :StringSql( "BRINFCOM", 60 )
      mbrInfVen  := :StringSql( "BRINFVEN", 60 )
      mbrInfInc  := :StringSql( "BRINFINC", 80 )
      mbrInfAlt  := :StringSql( "BRINFALT", 80 )
   ENDWITH
   ::ShowTabs()

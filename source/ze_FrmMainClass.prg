...
FUNCTION IconFromCaption( cCaption, cTooltip )
   ...
   CASE cCaption == "<H>HistEmails" ;            cSource := "icoMailHist" ;     cTooltip := "H Histórico dos emails de NFE enviados" // notas
   ...
   CASE cCaption == "<T>T.Conta" ;               cSource := "icoChange" ;       cTooltip := "T Troca a conta deste lançamento" // bancario

...
FUNCTION ze_UpdateMysql()
   ...
   WITH OBJECT cnMySql
      ...
      IF AppVersaoDbf() < 20190101
         :ExecuteCmd( "DELETE FROM JPREGUSO WHERE RUINFINC < 2019/01/01 AND ISEMPTY( RUCODIGO )" )
      ENDIF
      IF AppVersaoDbf() < 20150101
         JPDECRETMySqlDefault()
      ENDIF
   ENDWITH
...
FUNCTION JPDECRETMySqlDefault()
   ...
   cnMySql:cSql := "SELECT COUNT(*) AS QTD FROM JPDECRET"
